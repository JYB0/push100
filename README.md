...
운동을 꾸준히 이어가는 것이 중요하다는 것을 알면서도,  
명확한 목표와 피드백이 없으면 쉽게 중단하게 되는 문제를 느꼈습니다.

특히 푸시업과 같은 간단한 운동도  
진행 상황을 기록하고 성취를 확인할 수 있는 구조가 없다면  
습관으로 이어지기 어렵다고 생각했습니다.

이를 해결하기 위해 사용자의 초기 테스트 결과를 기반으로  
단계별 운동 계획을 제공하고,  
운동 진행 → 휴식 → 기록 저장으로 이어지는 흐름을 설계했습니다.

Push100은 단순한 기록 앱이 아니라,  
사용자가 운동을 지속할 수 있도록 동기부여와 흐름을 함께 제공하는  
습관 형성 중심의 운동 앱을 목표로 개발했습니다.
